<?php
  require('header.php');
   ...
   $curren_products_index = $add_home->allCurrenProducts();
?>
...
background: radial-gradient(circle, rgba(255,0,0,1) 0%, rgba(0,0,0,1) 100%);">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h5 class="text-white fw-bold fs-1">Curren Watch Products</h5>
      </div>
       <div>
      <?php
        if(mysqli_num_rows($curren_products_index) > 0){
            while($curren_products_index = mysqli_fetch_assoc($curren_products_index)){
      ?>
      <div class="row my-5">
        <div class="col-12">
          <div class="card" style="width: 100%;">
            <div class="card-body">
              <h3 class="card-title">Product Name: <span class="fw-normal"><?php echo $curren_products_index['name']; ?></span></h3>
              <h4 class="mt-5 card-text">Product Brand: <span class="fw-normal"><?php echo $curren_products_index['brand']; ?></span></h4>
              <h4 class="mt-2 card-text">Product Model: <span class="fw-normal"><?php echo $curren_products_index['model']; ?></span></h4>
              <h5 class="mt-5">Product Details: <span class="fw-normal"><?php echo $curren_products_index['details']; ?></span></h5>
              <div class="row mt-5">
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $curren_products_index['image1']; ?>" alt="<?php echo $curren_products_index['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $curren_products_index['image2']; ?>" alt="<?php echo $curren_products_index['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $curren_products_index['image3']; ?>" alt="<?php echo $curren_products_index['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
              </div>
              <div class="mt-5 d-flex justify-content-center">
                <button class="btn btn-lg btn-danger">
                  <a class="text-light" href="curren_cart.php?id=<?php echo $curren_products_index['id']; ?>" style="text-decoration:none;">Add to Cart</a>
                </button>
              </div>
            </div>
          </div>
