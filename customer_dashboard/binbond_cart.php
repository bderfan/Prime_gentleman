<?php
  ...
  require('header.php');
   ...
   $products_card = $add_home->BinbondProductsCard($_GET['id']);

    if(isset($_POST['cart'])){
      
      $cart = $add_home->BinbondCart($_POST);
      $old = $_POST;         
      #print_r($old);
      ...
      <div class="row my-5">
        <div class="col-12">
          <div class="card" style="width: 100%;">
            <div class="card-body">
              <h3 class="card-title">Product Name: <span class="fw-normal"><?php echo $products_card['name']; ?></span></h3>
              <h4 class="mt-5 card-text">Product Brand: <span class="fw-normal"><?php echo $products_card['brand']; ?></span></h4>
              <h4 class="mt-2 card-text">Product Model: <span class="fw-normal"><?php echo $products_card['model']; ?></span></h4>
              <h5 class="mt-5">Product Details: <span class="fw-normal"><?php echo $products_card['details']; ?></span></h5>
              <div class="row mt-5">
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $products_card['image1']; ?>" alt="<?php echo $products_card['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $products_card['image2']; ?>" alt="<?php echo $products_card['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
                <div class="col-4 text-center">
                  <div class="d-flex justify-content-center">
                    <img src="../images/products_img/<?php echo $products_card['image3']; ?>" alt="<?php echo $products_card['name']; ?>" style="width:100%; height: 300px;"> 
                  </div>
                </div>
              </div>
             <form class="mt-5" method="post">
                       <label for="quantity" class="fs-4 fw-bold text-black d-flex justify-content-center">Quantity</label>
                       <div class="d-flex justify-content-center">
                       ...
                       <div class="d-flex justify-content-center">
                          <button type="submit" name="cart" class="btn btn-warning mt-4">Cart</button>
                       </div>
             </form>  
            </div>
          </div>
