 <?php
      ...
      if(isset($_POST['add_products'])){
          $products_add = $add_product->Curren_Product_add();
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <div class="d-flex justify-content-end my-3">
                <!-- Button trigger modal -->
                 <a href="curren_watch.php" class="btn" style="background-color: #C28B37;">
               ...
               <div class="my-3">
                ...
                <p class="text-white" style="font-size:15px;"> <?php echo $errors['price']??'' ?></p>
                  ...
                  <div class="my-3">
                       ...
                       <textarea id="details3" name="details3"><?php echo $old['details3']?? ''; ?></textarea>     
                  </div>
