 <?php
      ...
      if(isset($_POST['edit_products'])){
          $products_edit = $add_product->Curren_Product_edit();
    ...
    $targetdata = $add_product->targetcurrenData($_GET['sku']);
              ...
              <input type="hidden" name="update_product_id" value="<?php echo $targetdata['id']?? ''; ?>">
               ...
               <div class="my-3">
                ...
                <p class="text-white" style="font-size:15px;"> <?php echo $errors['price']??'' ?></p>
                  ...
                  <div class="my-3">
                      <label class="fw-bold text-white mb-2" for="details3">Details</label>
                      <textarea id="details3" name="details3"><?php echo $old['details3']??$targetdata['details']?? ''; ?></textarea>
                  </div>
                  <p class="text-white" style="font-size:15px;"> <?php echo $errors['details3']??'' ?></p>
...
<script>
    ClassicEditor
        .create( document.querySelector( '#details3' ) )
        .then( editor => {
