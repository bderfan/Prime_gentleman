      ...
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/brand')) ? 'active': ''; ?> fw-bold" href="brand.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
                 Brand
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/dashboard')) ? 'active': ''; ?> fw-bold" href="binbond_watch.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
                 <img src="../images/Binbond.png" style="width:150px; height:75px;">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/dashboard')) ? 'active': ''; ?> fw-bold" href="curren_watch.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
                 <img src="../images/Curren.jpeg" style="width:150px; height:75px;">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/dashboard')) ? 'active': ''; ?> fw-bold" href="megir_watch.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
                 <img src="../images/Megir.jpeg" style="width:150px; height:75px;">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/dashboard')) ? 'active': ''; ?> fw-bold" href="mreurio_watch.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
                 <img src="../images/Mreurio.png" style="width:150px; height:75px;">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/dashboard')) ? 'active': ''; ?> fw-bold" href="skmei_watch.php" style="font-size:20px;">
                 <img src="../images/watchicon.png" style="width:20px; height:20px">
