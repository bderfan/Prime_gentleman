 <?php
      ...
      if(isset($_POST['edit_products'])){
          $products_edit = $add_product->Binbond_Product_edit();
    ...
    $targetdata = $add_product->targetbinbondData($_GET['sku']);
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <div class="d-flex justify-content-end my-3">
                <!-- Button trigger modal -->
                 <a href="binbond_watch.php" class="btn" style="background-color: #C28B37;">
       ...
       <div>
          ...
          <?php
             header('Refresh:1,url=binbond_watch.php');
             }
          ?>  
      </div>
      <div class="container">
              ...
              <input type="hidden" name="update_product_id" value="<?php echo $targetdata['id']?? ''; ?>">
               ...
               <div class="my-3">
                ...
                <p class="text-white" style="font-size:15px;"> <?php echo $errors['price']??'' ?></p>
                  ...
                  <div class="my-3">
                      <label class="fw-bold text-white mb-2" for="details2">Details</label>
                      <textarea id="details2" name="details2"><?php echo $old['details2']??$targetdata['details']?? ''; ?></textarea>
                  </div>
                  <p class="text-white" style="font-size:15px;"> <?php echo $errors['details2']??'' ?></p>
...
<script>
    ClassicEditor
        .create( document.querySelector( '#details2' ) )
        .then( editor => {
