 <?php
      ...
      if(isset($_POST['edit_products'])){
          $products_edit = $add_product->Mreurio_Product_edit();
    ...
    $targetdata = $add_product->targetmreurioData($_GET['sku']);
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <div class="d-flex justify-content-end my-3">
                <!-- Button trigger modal -->
                 <a href="mreurio_watch.php" class="btn" style="background-color: #C28B37;">
       ...
       <div>
          ...
          <?php
             header('Refresh:1,url=mreurio_watch.php');
             }
          ?>  
      </div>
      <div class="container">
              ...
              <input type="hidden" name="update_product_id" value="<?php echo $targetdata['id']?? ''; ?>">
               ...
               <div class="my-3">
                ...
                <p class="text-white" style="font-size:15px;"> <?php echo $errors['price']??'' ?></p>
                  ...
                  <div class="my-3">
                      <label class="fw-bold text-white mb-2" for="details5">Details</label>
                      <textarea id="details5" name="details5"><?php echo $old['details5']??$targetdata['details']?? ''; ?></textarea>
                  </div>
                  <p class="text-white" style="font-size:15px;"> <?php echo $errors['details5']??'' ?></p>
...
<script>
    ClassicEditor
        .create( document.querySelector( '#details5' ) )
        .then( editor => {
