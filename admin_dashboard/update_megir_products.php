 <?php
      ...
      if(isset($_POST['edit_products'])){
          $products_edit = $add_product->Megir_Product_edit();
    ...
    $targetdata = $add_product->targetmegirData($_GET['sku']);
               ...
               <div class="my-3">
                ...
                <p class="text-white" style="font-size:15px;"> <?php echo $errors['price']??'' ?></p>
                  ...
                  <div class="my-3">
                      ...
                      <textarea id="details4" name="details4"><?php echo $old['details4']??$targetdata['details']?? ''; ?></textarea>
                  </div>
